...
public class MainFrame {
    ...
    private void createAndShowGUI() {
        ...
        // Initialize profile panel (will be added to content cards)
        profilePanel = new ProfilePanel(dbManager, () -> currentUser, frame, rootLayout, rootPanel);
        
        // Create public interface first (needs to be created before intro callback)
    ...
    public void handleLogout() {
        ...
        // Show LOGIN page in content cards
        if (contentLayout != null && contentCards != null) {
            contentLayout.show(contentCards, "LOGIN");
        }
    }
