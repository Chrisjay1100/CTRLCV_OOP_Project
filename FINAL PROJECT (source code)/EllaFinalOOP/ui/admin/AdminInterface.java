...
public class AdminInterface {
    ...
    private JPanel createDashboardPanel() {
        ...
        allRequests = dbManager.getPendingRequests();
        activityLogs = dbManager.getAllActivityLogs();
        
        int totalUsers = allUsers.size();
        int totalPills = allPills.size();
        int pendingRequests = allRequests.size();
        ...
        statsPanel.add(createStatCard("Recent Activities", String.valueOf(recentActivities), Color.MAGENTA));
    ...
    private JPanel createUserManagementPanel() {
        ...
        // User table
        String[] columns = {"Username", "Name", "Email", "Role", "Age", "Created Date"};
        ...
        panel.add(title, BorderLayout.NORTH);
        panel.add(searchSortPanel, BorderLayout.CENTER);
    ...
    private void changeUserRole() {
        ...
        if ("Admin".equalsIgnoreCase(user.role) && "Admin".equalsIgnoreCase(currentAdmin.role)) {
            JOptionPane.showMessageDialog(frame, "You cannot change roles of other Admin accounts.");
            return;
        }
        
        String[] roles = {"Customer", "Manager"};
        String currentRole = user.role != null ? user.role : "Customer";
        ...
        if (newRole != null && !newRole.equals(currentRole)) {
            ...
            if ("Admin".equalsIgnoreCase(newRole)) {
                JOptionPane.showMessageDialog(frame, "Cannot change role to Admin.");
                return;
            }
    ...
    private void deleteSelectedUser() {
        ...
        if ("Admin".equalsIgnoreCase(user.role) && "Admin".equalsIgnoreCase(currentAdmin.role)) {
            JOptionPane.showMessageDialog(frame, "You cannot delete other Admin accounts.");
            return;
        }
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            ...
            if (success) {
                logActivity("DELETE_USER", "username: " + username);
    ...
    private JPanel createAdminGuidePanel() {
        ...
        guideArea.setText(
            ...
            "   - Includes: Add/Edit/Delete medicines, Edit/Delete users, Role changes, etc.\n\n" +
