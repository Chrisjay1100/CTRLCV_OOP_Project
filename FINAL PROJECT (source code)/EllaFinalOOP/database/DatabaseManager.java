...
public class DatabaseManager {
    ...
    /**
     * Changes user role (only allows changing to lower roles, not equal or higher)
    ...
    public boolean changeUserRole(String username, String newRole, String currentAdminRole) {
        // Prevent changing to same or higher role
        if ("Admin".equalsIgnoreCase(currentAdminRole)) {
            if ("Admin".equalsIgnoreCase(newRole)) {
                return false; // Cannot change to Admin
            }
        } else if ("Manager".equalsIgnoreCase(currentAdminRole)) {
